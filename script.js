...
function circleChaptaKaro() {
  ...
  window.addEventListener("mousemove", function (dets) {
    ...
    xscale = gsap.utils.clamp(1.5,2.5, dets.clientX - xprev);
    yscale = gsap.utils.clamp(1.5,2.5, dets.clientY - yprev);
...
function circleMouseFollower(xscale, yscale) {
  ...
  document.querySelector("#minicircle").style.backgroundColor = "green";
}
